module.exports=function(){
    ...
    this.ToArguments=function(){
        ...
        if(this.Server!=null&&this.Server!=undefined&&this.Server.Address!=null&&this.Server.Address!=undefined&&this.Server.Address!=''){
            ...
            sb.push('--port');
            sb.push(this.Server.Port==0||this.Server.Port==undefined?'25565':this.Server.Port.toString());
        }
        ...
        for(var i=0;i<this.AdvencedArguments.length;i++)if(this.AdvencedArguments[i]!='')sb.push(this.AdvencedArguments[i]);
        return sb;
    }
}