    ...
    DownloadLibraries(libs,p,fun){
        ...
        for(var i=0;i<libs.length;i++){
            ...
            try{
                ...
                if(libs[i].Url==undefined)arr.push({Url:'http://bmclapi2.bangbang93.com/libraries/'+libs[i],File:file});else if(libs[i].Url==='http://files.minecraftforge.net/maven/')
                arr.push({Url:'http://bmclapi2.bangbang93.com/libraries/'+libs[i].Name,File:file});else if(libs[i].Url.indexOf(libs[i].Name)==-1)
